...
echo "Deploying production madRAG (using external databases)..."
...
helm upgrade --install madrag $SCRIPT_DIR/madrag \
  --namespace $NAMESPACE \
...
# Wait for madRAG pod to be ready
echo ""
echo "Waiting for madrag pod to be ready..."
kubectl wait --for=condition=ready pod -l app.kubernetes.io/instance=madrag --timeout=300s -n rag
echo "madrag pod is ready"
echo ""
echo "Running Port-Forward:"
echo "    kubectl --namespace rag port-forward svc/madrag 9621:9621"
echo "==========================================="
echo ""
echo "✅ You can visit madRAG at: http://localhost:9621"
echo ""
