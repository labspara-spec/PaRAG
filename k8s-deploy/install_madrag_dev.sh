...
helm upgrade --install madrag-dev $SCRIPT_DIR/madrag \
  --namespace rag \
...
echo ""
echo "Waiting for madrag-dev pod to be ready..."
kubectl wait --for=condition=ready pod -l app.kubernetes.io/instance=madrag-dev --timeout=300s -n rag
echo "madrag-dev pod is ready"
echo ""
echo "Running Port-Forward:"
echo "    kubectl --namespace rag port-forward svc/madrag-dev 9621:9621"
echo "==========================================="
echo ""
