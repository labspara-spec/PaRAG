"""
madRAG Data Isolation Demo: Workspace Management

This example demonstrates how to maintain multiple isolated knowledge bases
within a single application using madRAG's 'workspace' feature.
...
Usage:
    python madrag_workspace_demo.py
"""
...
async def initialize_rag(
    ...
    """
    Initializes a madRAG instance with data isolation.

    Entity type guidance can be customized by passing
    addon_params={'entity_types_guidance': '...'} to madRAG.
    """
...
async def main():
    ...
    try:
        ...
        print("Initializing isolated madRAG workspaces...")
