...
from madrag.utils import locate_json_string_body_from_string
...
async def initialize_rag():
    ...
    rag = madRAG(
        ...
        embedding_func=EmbeddingFunc(
            ...
            # so truncate (trunc) parameter on embedding_func will handle it and try to examine the tokenizer used in madRAG
