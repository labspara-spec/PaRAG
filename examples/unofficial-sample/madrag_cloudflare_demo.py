...
from madrag.utils import EmbeddingFunc, logger, set_verbose_debug

import requests
import numpy as np
from dotenv import load_dotenv

"""This code is a modified version of madrag_openai_demo.py"""
...
class CloudflareWorker:
    ...
    async def query(self, prompt, system_prompt: str = "", **kwargs) -> str:
        # since no caching is used and we don't want to mess with everything madrag, pop the kwarg it is
...
def configure_logging():
    ...
    log_file_path = os.path.abspath(
        os.path.join(log_dir, "madrag_cloudflare_worker_demo.log")
    )

    print(f"\nmadRAG compatible demo log file: {log_file_path}\n")
