"""
madRAG Demo with OpenSearch + OpenAI
...
2. Required indices will be auto-created by madRAG
...
from madrag.utils import setup_logger, EmbeddingFunc
...
async def main():
    rag = None
    try:
        print("Initializing madRAG with OpenSearch + OpenAI...")
