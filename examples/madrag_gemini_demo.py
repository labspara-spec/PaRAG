"""
madRAG Demo with Google Gemini Models

This example demonstrates how to use madRAG with Google's Gemini 2.0 Flash model
...
Usage:
    python examples/madrag_gemini_demo.py
"""
