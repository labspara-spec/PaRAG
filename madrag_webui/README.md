...
madRAG WebUI is a React-based web interface for interacting with the madRAG system. It provides a user-friendly interface for querying, managing, and exploring madRAG's functionalities.
...
2. **Install Dependencies:**
    ...
    In the `madrag_webui` directory, run the following command to install project dependencies:
...
3. **Build the Project:**
    ...
    This command will bundle the project and output the built files to the `madrag/api/webui` directory.
