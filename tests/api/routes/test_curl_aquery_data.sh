...
# madRAG aquery_data endpoint test script
# Use curl command to test the new /query/data endpoint and validate the new data format

echo "🚀 madRAG aquery_data Endpoint Test (New Data Format Validation)"
echo "=================================================="
...
echo "1. Ensure madRAG API service is running (python -m madrag.api.madrag_server)"
