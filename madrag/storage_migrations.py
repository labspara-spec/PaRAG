"""Storage data migration helpers for :class:`madRAG`.

Mixed into madRAG and runs once at startup (``initialize_storages`` →
...
from madrag.kg.shared_storage import get_data_init_lock
from madrag.utils import logger, make_relation_chunk_key


class _StorageMigrationMixin:
    """Mixin that owns one-shot data migrations on :class:`madRAG`.
