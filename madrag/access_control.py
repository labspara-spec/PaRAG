"""Access control helpers for madRAG chunk retrieval.

Access control is **disabled by default**.  Set ``ENABLE_ACCESS_CONTROL=true``
(env var) or pass ``enable_access_control=True`` to the ``madRAG``
...
from madrag.constants import ENABLE_ACCESS_CONTROL
