...
:func:`madrag.chunker.recursive_character.chunking_by_recursive_character`
...
from madrag.chunker.recursive_character import chunking_by_recursive_character
...
def chunking_by_section_aware(
    ...
    **kwargs: Any,
    ...
    Args:
        tokenizer: madRAG tokenizer for token-accurate sizing.
