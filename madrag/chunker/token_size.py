"""Fixed-size token-window chunking — the madRAG default strategy.
...
Two entry points are exported:
  ...
  - :func:`chunking_by_token_size` — the **legacy 6-arg signature**
    used as the default value for :attr:`madrag.madRAG.chunking_func`.
...
from madrag.exceptions import ChunkTokenLimitExceededError
...
def chunking_by_token_size(
    ...
    """Legacy 6-arg fixed-token chunker (default for ``madRAG.chunking_func``).
