...
output rows in the madRAG file-chunker schema. The splitter walks the
...
Token accounting goes through the madRAG :class:`Tokenizer` via the
...
:func:`madrag.utils.enforce_chunk_token_limit_before_embedding` does the
...
def chunking_by_recursive_character(
    ...
    *,
    ...
    Args:
        tokenizer: madRAG tokenizer; used as the length function so
