...
from madrag.api.utils_api import (
...
from madrag.utils import get_env_value
from madrag import madRAG, ROLES, RoleLLMConfig, __version__ as core_version
from madrag.api import __api_version__
...
from madrag.api.routers.document_routes import (
    DocumentManager,
...
from madrag.parser.external.mineru.cache import MinerUParserOptions
from madrag.api.routers.query_routes import create_query_routes
from madrag.api.routers.graph_routes import create_graph_routes
from madrag.api.routers.webhook_routes import create_webhook_routes
from madrag.storage.cloud import get_cloud_provider
from madrag.utils import logger, set_verbose_debug
...
from madrag.api.auth import auth_handler

# use the .env that is inside the current folder
# allows to use different .env file for each madrag instance
...
def _inject_swagger_theme(html: str, theme: str) -> str:
    ...
    # single boolean attribute `data-madrag-docs-dark` on <html>. CSS below
          ...
          (function () {{
            ...
            function apply(value) {{
              ...
              if (resolveDark(currentTheme)) {{
                root.setAttribute('data-madrag-docs-dark', '1');
              }} else {{
                root.removeAttribute('data-madrag-docs-dark');
              }}
            }}
            apply(currentTheme);
            ...
            window.addEventListener('message', function (event) {{
              var data = event.data;
              if (!data || data.type !== 'madrag:set-docs-theme') return;
              apply(data.theme);
            }});
          }})();
        </script>
        <style>
          html[data-madrag-docs-dark="1"] {{
            color-scheme: dark;
          }}

          html[data-madrag-docs-dark="1"] body,
          html[data-madrag-docs-dark="1"] .swagger-ui,
          html[data-madrag-docs-dark="1"] .swagger-ui .scheme-container,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models,
          html[data-madrag-docs-dark="1"] .swagger-ui .model-box,
          html[data-madrag-docs-dark="1"] .swagger-ui .opblock,
          html[data-madrag-docs-dark="1"] .swagger-ui .dialog-ux .modal-ux,
          html[data-madrag-docs-dark="1"] .swagger-ui .auth-container {{
            background: #0f172a;
            color: #e5e7eb;
          }}

          html[data-madrag-docs-dark="1"] .swagger-ui .info .title,
          html[data-madrag-docs-dark="1"] .swagger-ui .opblock-tag,
          html[data-madrag-docs-dark="1"] .swagger-ui .opblock .opblock-summary-description,
          html[data-madrag-docs-dark="1"] .swagger-ui .model-title,
          html[data-madrag-docs-dark="1"] .swagger-ui .parameter__name,
          html[data-madrag-docs-dark="1"] .swagger-ui .parameter__type,
          html[data-madrag-docs-dark="1"] .swagger-ui .response-col_status,
          html[data-madrag-docs-dark="1"] .swagger-ui .response-col_description,
          html[data-madrag-docs-dark="1"] .swagger-ui .auth-container h4,
          html[data-madrag-docs-dark="1"] .swagger-ui .auth-container label,
          html[data-madrag-docs-dark="1"] .swagger-ui .auth-container p,
          html[data-madrag-docs-dark="1"] .swagger-ui .markdown p,
          html[data-madrag-docs-dark="1"] .swagger-ui .markdown li,
          html[data-madrag-docs-dark="1"] .swagger-ui .renderedMarkdown p,
          html[data-madrag-docs-dark="1"] .swagger-ui .renderedMarkdown li,
          html[data-madrag-docs-dark="1"] .swagger-ui table thead tr th,
          html[data-madrag-docs-dark="1"] .swagger-ui table tbody tr td,
          html[data-madrag-docs-dark="1"] .swagger-ui .tab li,
          html[data-madrag-docs-dark="1"] .swagger-ui .tab li button.tablinks {{
            color: #e5e7eb;
          }}

          html[data-madrag-docs-dark="1"] .swagger-ui .opblock-description-wrapper p,
          html[data-madrag-docs-dark="1"] .swagger-ui .opblock-external-docs-wrapper p,
          html[data-madrag-docs-dark="1"] .swagger-ui .response-col_links {{
            color: #cbd5f5;
          }}

          html[data-madrag-docs-dark="1"] .swagger-ui input,
          html[data-madrag-docs-dark="1"] .swagger-ui textarea,
          html[data-madrag-docs-dark="1"] .swagger-ui select {{
            background: #020617;
            border-color: #334155;
            color: #f8fafc;
          }}

          html[data-madrag-docs-dark="1"] .swagger-ui .markdown code,
          html[data-madrag-docs-dark="1"] .swagger-ui .renderedMarkdown code,
          html[data-madrag-docs-dark="1"] .swagger-ui .highlight-code,
          html[data-madrag-docs-dark="1"] .swagger-ui .highlight-code pre,
          html[data-madrag-docs-dark="1"] .swagger-ui .microlight,
          html[data-madrag-docs-dark="1"] .swagger-ui .body-param__example,
          html[data-madrag-docs-dark="1"] .swagger-ui .example,
          html[data-madrag-docs-dark="1"] .swagger-ui .model-example pre {{
            background: #020617;
            color: #e2e8f0;
          }}
          ...
          html[data-madrag-docs-dark="1"] .swagger-ui .tab li.active button.tablinks,
          html[data-madrag-docs-dark="1"] .swagger-ui .tab li.tabitem.active {{
            color: #f8fafc;
            border-bottom-color: #34d399;
          }}

          html[data-madrag-docs-dark="1"] .swagger-ui .btn.authorize,
          html[data-madrag-docs-dark="1"] .swagger-ui .auth-wrapper .authorize {{
            background: #064e3b;
            border-color: #34d399;
            color: #d1fae5;
          }}

          html[data-madrag-docs-dark="1"] .swagger-ui .btn.authorize svg {{
            fill: #d1fae5;
          }}
          ...
          html[data-madrag-docs-dark="1"] .swagger-ui section.models,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models.is-open,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models h4,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models .model-container,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models .models-control,
          html[data-madrag-docs-dark="1"] .swagger-ui .model-box {{
            background: #111827;
            border-color: #334155;
          }}
          ...
          html[data-madrag-docs-dark="1"] .swagger-ui section.models h4,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models h4 button,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models h4 a,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models h4 span,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models .models-control,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models .models-control button,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models .model-toggle,
          html[data-madrag-docs-dark="1"] .swagger-ui .model,
          html[data-madrag-docs-dark="1"] .swagger-ui .model .model-title__text,
          html[data-madrag-docs-dark="1"] .swagger-ui .model .property,
          html[data-madrag-docs-dark="1"] .swagger-ui .model .prop-name,
          html[data-madrag-docs-dark="1"] .swagger-ui .model .prop-type,
          html[data-madrag-docs-dark="1"] .swagger-ui .model .prop-format,
          html[data-madrag-docs-dark="1"] .swagger-ui .expand-operation,
          html[data-madrag-docs-dark="1"] .swagger-ui .expand-operation span {{
            color: #e5e7eb;
          }}

          html[data-madrag-docs-dark="1"] .swagger-ui section.models h4 svg,
          html[data-madrag-docs-dark="1"] .swagger-ui section.models .models-control svg,
          html[data-madrag-docs-dark="1"] .swagger-ui .model-toggle::after,
          html[data-madrag-docs-dark="1"] .swagger-ui .expand-operation svg,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion__icon svg,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion__icon svg path {{
            fill: #e5e7eb;
          }}
          ...
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12__title,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-property .json-schema-2020-12__title,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-expand-deep-button,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--primary,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--primary,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--primary,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--primary,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--primary,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--const .json-schema-2020-12-json-viewer__name,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--const .json-schema-2020-12-json-viewer__value,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--default .json-schema-2020-12-json-viewer__name,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--default .json-schema-2020-12-json-viewer__value,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--enum .json-schema-2020-12-json-viewer__name,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--enum .json-schema-2020-12-json-viewer__value,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--examples .json-schema-2020-12-json-viewer__name,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--examples .json-schema-2020-12-json-viewer__value {{
            color: #e5e7eb;
          }}

          /* Secondary / extension / description text — keep them visible but
             dimmer than primary titles. */
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--secondary,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--secondary,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--extension,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--extension,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--description,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--secondary,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--secondary,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--extension,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--extension,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer-extension-keyword .json-schema-2020-12-json-viewer__name,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer-extension-keyword .json-schema-2020-12-json-viewer__value,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--muted {{
            color: #cbd5f5;
          }}
          ...
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--warning,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--warning,
          html[data-madrag-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--warning {{
            color: #fca5a5;
            border-color: #fca5a5;
          }}
          ...
          /* Per-operation Authorize lock icon. Swagger renders it via
             ...
             states. */
          html[data-madrag-docs-dark="1"] .swagger-ui .authorization__btn svg,
          html[data-madrag-docs-dark="1"] .swagger-ui .authorization__btn .locked,
          html[data-madrag-docs-dark="1"] .swagger-ui .authorization__btn .unlocked {{
            fill: #e5e7eb;
          }}
        </style>
        """
...
# and matches how madRAG is deployed in practice. See
...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding in ["openai", "azure_openai"]:
            from madrag.llm.binding_options import OpenAILLMOptions
        ...
        if args.llm_binding == "gemini":
            from madrag.llm.binding_options import GeminiLLMOptions
        ...
        if args.llm_binding == "bedrock":
            from madrag.llm.binding_options import BedrockLLMOptions
        ...
        if args.embedding_binding == "gemini":
            try:
                from madrag.llm.binding_options import GeminiEmbeddingOptions
...
def check_frontend_build():
    ...
    if not index_html.exists():
        ...
        ASCIIColors.cyan("    cd madrag_webui")
    ...
    try:
        source_dir = Path(__file__).parent.parent.parent / "madrag_webui"
        ...
        # Key configuration files (in madrag_webui root directory)
        key_files = [
...
def build_rag_factory(args, event_bus=None):
    """
    Build an async per-workspace madRAG factory from config args.

    Used by ``worker_service`` to create instances without a full API server.
    Returns an async callable::

        factory(workspace: str) -> madRAG   # already initialized
    ...
    """
    from madrag.api.config import global_args as _ga
    ...
    # ------------------------------------------------------------------ LLM
    if binding == "lollms":
        from madrag.llm.lollms import lollms_model_complete as _llm
        llm_func = _llm
    elif binding == "bedrock":
        from madrag.llm.bedrock import bedrock_complete_if_cache as _bedrock
        ...
        from madrag.llm.gemini import gemini_complete_if_cache as _gemini
        ...
        from madrag.llm.azure_openai import azure_openai_complete_if_cache as _az
        ...
        from madrag.llm.openai import openai_complete_if_cache as _oai
    ...
    # --------------------------------------------------------------- Embedding
    from madrag.utils import EmbeddingFunc as _EF
    ...
    async def _emb_inner(texts, embedding_dim=None, context="document"):
        if emb_binding == "gemini":
            from madrag.llm.gemini import gemini_embed
            ...
            from madrag.llm.jina import jina_embed
            ...
            from madrag.llm.azure_openai import azure_openai_embed
            ...
            from madrag.llm.bedrock import bedrock_embed
            ...
            from madrag.llm.voyageai import voyageai_embed
            ...
            from madrag.llm.lollms import lollms_embed
            ...
            from madrag.llm.openai import openai_embed
    ...
    # ----------------------------------------------------------- madRAG factory
    async def factory(workspace: str) -> "madRAG":
        instance = madRAG(
...
def create_app(args):
    ...
    async def lifespan(app: FastAPI):
        ...
        if getattr(args, "cloud_mode", False):
            try:
                ...
                from madrag.api.sse_bus import LocalSSEBus
    ...
    base_description = (
        "Providing API for madRAG core and Web UI"
    )
    swagger_description = (
        base_description
    ...
    def create_optimized_openai_llm_func(
        ...
        async def optimized_openai_alike_model_complete(
            ...
            **kwargs,
            ...
            from madrag.llm.openai import openai_complete_if_cache
    ...
    def create_optimized_azure_openai_llm_func(
        ...
        async def optimized_azure_openai_model_complete(
            ...
            **kwargs,
            ...
            from madrag.llm.azure_openai import azure_openai_complete_if_cache
    ...
    def create_optimized_gemini_llm_func(
        ...
        async def optimized_gemini_model_complete(
            ...
            **kwargs,
            ...
            from madrag.llm.gemini import gemini_complete_if_cache
    ...
    def create_llm_model_func(binding: str):
        ...
        try:
            if binding == "lollms":
                from madrag.llm.lollms import lollms_model_complete
    ...
    def create_role_llm_func(role: str, override_meta: dict | None = None):
        ...
        try:
            if role_binding == "lollms":
                from madrag.llm.lollms import lollms_model_if_cache
            ...
            if role_binding == "bedrock":
                from madrag.llm.bedrock import bedrock_complete_if_cache
    ...
    if args.rerank_binding != "null":
        from madrag.rerank import cohere_rerank, jina_rerank, ali_rerank
    ...
    # madRAG.__post_init__ normalizes addon_params and backfills env-based defaults
    ...
    def _build_image_embedding_func():
        ...
        if os.getenv("GEMINI_IMAGE_EMBED_ENABLE", "false").lower() != "true":
            return None
        try:
            from madrag.llm.gemini import gemini_multimodal_embed_text
    ...
    # Factory creates a fully-configured madRAG instance for any workspace.
    ...
    async def _rag_factory(workspace: str) -> madRAG:
        try:
            instance = madRAG(
                working_dir=args.working_dir,
                workspace=workspace,
            ...
            logger.error(f"Failed to initialize madRAG for workspace={workspace!r}: {e}")
            raise
        await instance.initialize_storages()
        await instance.check_and_migrate_data()

        # Build guardrail pipeline when enabled (GUARDRAILS_ENABLED=true)
        from madrag.api.config import get_guardrail_config
        from madrag.guardrails import GuardrailPipeline
    ...
    from madrag.api.pool import madRAGPool
    ...
    @app.get(
        ...
        summary="madRAG instance pool status",
        tags=["system"],
    )
    async def get_pool_status():
        """Live snapshot of the madRAG instance pool (workspaces, ref counts, idle time)."""
        return {
...
def configure_logging():
    ...
    for logger_name in ["uvicorn", "uvicorn.access", "uvicorn.error", "madrag"]:
    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "path_filter": {
                    "()": "madrag.utils.LightragPathFilter",
                },
            },
        }
    )
...
def main():
    ...
    # See: https://github.com/HKUDS/madRAG/issues/2438
