"""
Utility functions for the madRAG API.
"""
...
from madrag.api.runtime_validation import validate_runtime_target_from_env_file
    ...
    async def combined_dependency(
        ...
        if token:
            try:
                ...
                from madrag.api.config import global_args
...
def display_splash_screen(args: argparse.Namespace) -> None:
    """
    Display a colorful splash screen showing madRAG server configuration
    ...
    line1_text = f"madRAG Server v{core_version}/{api_version}"
