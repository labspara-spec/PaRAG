...
from madrag import ROLES
from madrag.utils import get_env_value, logger
from madrag.llm.binding_options import (
    BedrockLLMOptions,
...
DEFAULT_TOKEN_SECRET = "madrag-jwt-default-secret-key!"
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="madRAG API Server")
    ...
    parser.add_argument(
        ...
        help="API key for authentication. This protects madrag server against unauthorized access",
    )
    ...
    # --- Per-role LLM configuration (driven by madrag.ROLES registry) ---
    for spec in ROLES:
    ...
    # Worker configuration (used by madrag-worker service)
...
def initialize_config(args=None, force=False):
    ...
    which is useful for programmatic usage, testing, or embedding madRAG
...
def get_guardrail_config():
    ...
    """
    from madrag.guardrails import GuardrailConfig
