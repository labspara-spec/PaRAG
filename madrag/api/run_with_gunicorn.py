#!/usr/bin/env python
"""
Start madRAG server with Gunicorn
"""
...
# Capture this before importing madRAG modules, because those imports load .env.
...
def main():
    from madrag.api.utils_api import display_splash_screen, check_env_file
    from madrag.api.config import global_args, initialize_config
    ...
    print("🚀 Starting madRAG with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load(self):
            ...
            from madrag.api.madrag_server import get_application
