"""madRAG native DOCX parser package.
...
:meth:`madrag.pipeline._PipelineMixin.parse_native` so the native and
MinerU engines share one shape; see :mod:`madrag.parser.docx.ir_builder`
