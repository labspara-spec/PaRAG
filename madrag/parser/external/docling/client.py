...
from madrag.parser.external._common import (
    env_bool,
    env_int,
    raise_for_status_with_detail,
)
from madrag.parser.external._zip import safe_extract_zip
from madrag.parser.external.docling.cache import (
    compute_options_signature,
    current_endpoint_signature,
    snapshot_tunable_env,
)
from madrag.parser.external.docling.manifest import (
...
class DoclingRawClient:
    ...
    async def download_into(
        ...
        *,
        ...
        :func:`madrag.parser.external.clear_dir_contents`). This method
