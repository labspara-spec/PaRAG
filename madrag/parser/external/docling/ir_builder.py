...
from madrag.parser.external._common import env_json
from madrag.parser.external.docling.manifest import select_main_json
...
def _build_ir_table(
    ...
    # filter in madrag/parser/external/mineru/ir_builder.py). Drop the
