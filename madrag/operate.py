...
from madrag.chunk_schema import strip_internal_multimodal_markup_for_extraction
from madrag.access_control import build_permission_filter, apply_permission_filter
from madrag.prompt import PROMPTS, resolve_entity_extraction_prompt_profile
...
from madrag.kg.shared_storage import get_storage_keyed_lock
import time
...
def _parse_mm_display_name(content: str, fallback: str) -> str:
    ...
    ``madRAG._build_mm_chunks_from_sidecars`` — the producer-side
...
async def extract_entities(
    ...
    if prompt_profile is None:
        ...
        # path that madRAG.__post_init__ populates, instead of duplicating
...
async def kg_query(
    ...
    if _context_guard is not None and context_result.context:
        try:
            ...
            from madrag.guardrails.base import GuardrailViolationError as _GVE
