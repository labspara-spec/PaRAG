#!/usr/bin/env python3
"""
LLM Cache Migration Tool for madRAG
...
Usage:
    python -m madrag.tools.migrate_llm_cache
    # or
    python madrag/tools/migrate_llm_cache.py
...
class MigrationTool:
    ...
    def print_header(self):
        """Print tool header"""
        print("\n" + "=" * 50)
        print("LLM Cache Migration Tool - madRAG")
        print("=" * 50)
