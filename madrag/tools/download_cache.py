...
def download_tiktoken_cache(cache_dir: str = None, models: list = None):
    ...
    # Common models used by madRAG and OpenAI
    if models is None:
        models = [
            "gpt-4o-mini",  # Default model for madRAG
            "gpt-4o",  # GPT-4 Omni
            "gpt-4",  # GPT-4
            ...
            "cl100k_base",  # Default encoding for madRAG
        ]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="madrag-download-cache",
        description="Download cache files for madRAG offline deployment",
...
For more information, visit: https://github.com/HKUDS/madRAG
        """,
    )
    ...
    parser.add_argument(
        "--version", action="version", version="%(prog)s (madRAG cache downloader)"
    )

    args = parser.parse_args()

    print("=" * 70)
    print("madRAG Offline Cache Downloader")
    print("=" * 70)
