# madRAG 3D Graph Viewer

An interactive 3D graph visualization tool included in the madRAG package for visualizing and analyzing RAG (Retrieval-Augmented Generation) graphs and other graph structures.
...
### Quick Install
```bash
pip install madrag-hku[tools]  # Install with visualization tool only
# or
pip install madrag-hku[api,tools]  # Install with both API and visualization tools
```
...
1. **Command Not Found**
   ...
   pip install madrag-hku[tools]

   # Verify installation
   pip list | grep madrag-hku
   ```
...
- GitHub Issues: [madRAG Repository](https://github.com/HKUDS/madRAG)
- Documentation: [madRAG Docs](https://URL-to-docs)

## License

This tool is part of madRAG and is distributed under the MIT License. See `LICENSE` for more information.

Note: This visualization tool is an optional component of the madRAG package. Install with the [tools] option to access the viewer functionality.
