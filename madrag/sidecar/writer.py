...
This module is the *single executable specification* of the madRAG sidecar
format (``docs/madRAGSidecarFormat-zh.md``). Engine adapters hand it an
...
from madrag.sidecar.placeholders import (
    render_drawing_tag,
    render_equation_tag,
    render_table_tag,
    render_template,
    ...
    *,
    ...
    for block_index, block in enumerate(ir.blocks):
        ...
        if block.page_number is not None:
            row["page_number"] = block.page_number
