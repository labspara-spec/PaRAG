...
Integration:
  ...
  madRAG.aquery_llm().  If `rag`, the caller proceeds normally.  If
...
# ---------------------------------------------------------------------------
# LLM prompt — loaded lazily from madrag/prompts/guardrails.xml
# ---------------------------------------------------------------------------
...
class IntentClassifier:
    ...
    Args:
        llm_func: Async callable matching the madRAG LLM function signature.
