...
from madrag.constants import DEFAULT_TEMPERATURE
...
# in madRAG. It provides a standardized framework for:
#
...
class BindingOptions:
    ...
    def generate_dot_env_sample(cls):
        """
        Generate a sample .env file for all madRAG binding options.
        ...
        sample_top = (
            ...
            + "\n"
            + (
                "# Autogenerated .env entries list for madRAG binding options\n"
                "#\n"
                "# To generate run:\n"
                "# $ python -m madrag.llm.binding_options\n"
            )
            + "#" * 80
            + "\n"
        )
        ...
        sample_bottom = (
            ("#\n# End of .env entries for madRAG binding options\n")
            + "#" * 80
            + "\n"
        )
...
# inferenceConfig that madRAG's bedrock driver actually forwards. See
# ``madrag/llm/bedrock.py`` for the whitelist — any field added here that is
...
#
# Usage:
#   python -m madrag.llm.binding_options           # Generate .env sample
#   python -m madrag.llm.binding_options test      # Test argument parsing
#
# =============================================================================
