...
async def zhipu_complete_if_cache(
    ...
    enable_cot: bool = False,  # madRAG output switch: include reasoning_content as <think>...</think>
    thinking: Optional[
        Dict[str, object]
    ...
    **kwargs,
    ...
    - `enable_cot`: madRAG-only formatting switch. When True and the API
...
async def zhipu_complete(
    ...
    **kwargs,
    ...
    """Zhipu completion wrapper with madRAG structured-output shims.
