"""CostPilot cost-tracking and service-health integration for madRAG LLM clients.

Enabled by setting COSTPILOT_API_KEY in the environment.
Install: pip install madrag-hku[observability]

Config priority (matches CostPilot SDK):
  constructor args → env vars → .costpilot.yaml → auto-generated from madRAG env → defaults

Service health tracking is auto-detected from madRAG's existing REDIS_URI / QDRANT_URL
...
#   3. .costpilot/_generated.yaml (auto-generated from madRAG env vars)
...
def _generate_config_yaml(api_key: str, project: str, environment: str) -> str:
    """Build .costpilot.yaml content from madRAG env vars."""
    import yaml  # PyYAML already in madRAG deps
