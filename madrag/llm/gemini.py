"""
Gemini LLM binding for madRAG.

This module provides asynchronous helpers that adapt Google's Gemini models
to the same interface used by the rest of the madRAG LLM bindings. The
...
def _normalize_gemini_response_schema(response_format: Any) -> Any | None:
    """Extract a Gemini-compatible JSON schema from madRAG/OpenAI inputs."""
