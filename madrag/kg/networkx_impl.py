...
class NetworkXStorage(BaseGraphStorage):
    ...
    async def upsert_node(self, node_id: str, node_data: dict[str, str]) -> None:
        ...
        Persistence:
            ...
            a subsequent ``index_done_callback``. In ``madrag.py`` this
