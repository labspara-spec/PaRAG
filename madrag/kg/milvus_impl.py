...
class MilvusVectorDBStorage(BaseVectorStorage):
    ...
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if self.namespace.endswith("entities"):
            ...
            description = "madRAG entities vector storage"
            ...
            description = "madRAG relationships vector storage"
            ...
            description = "madRAG chunks vector storage"
            ...
            description = "madRAG generic vector storage"
