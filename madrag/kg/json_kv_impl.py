...
from madrag.file_atomic import reap_orphan_tmp_files
...
from madrag.exceptions import StorageNotInitializedError
...
class JsonKVStorage(BaseKVStorage):
    ...
    async def _migrate_legacy_cache_structure(self, data: dict) -> dict:
        ...
        """
        from madrag.utils import generate_cache_key
