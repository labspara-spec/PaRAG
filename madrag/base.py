...
class PermissionFilter:
    ...
    Build via :func:`madrag.access_control.build_permission_filter`.
...
class BaseVectorStorage(StorageNameSpace, ABC):
    ...
    async def upsert(self, data: dict[str, dict[str, Any]]) -> None:
        ...
        Multi-worker note:
            ...
            madrag-gunicorn) other workers will not observe these writes
...
class BaseKVStorage(StorageNameSpace, ABC):
    ...
    async def upsert(self, data: dict[str, dict[str, Any]]) -> None:
        ...
        Multi-worker note:
            ...
            deployment (e.g. madrag-gunicorn) other workers will not
