...
logger = logging.getLogger("madrag")
...
def _patch_ascii_colors_console_handler() -> None:
    ...
    if getattr(ConsoleHandler, "_madrag_patched", False):
        return
    ...
    ConsoleHandler._madrag_patched = True  # type: ignore[attr-defined]
...
if TYPE_CHECKING:
    from madrag.base import BaseKVStorage, BaseVectorStorage, QueryParam
...
class LightragPathFilter(logging.Filter):
    """Filter for madrag logger to filter out frequent path access logs"""
...
def setup_logger(
    ...
    Args:
        ...
        log_file_path: Path to the log file. If None and file logging is enabled, defaults to madrag.log in LOG_DIR or cwd
...
class EmbeddingFunc:
    ...
    Args:
        ...
        max_token_size: Enable embedding token limit checking for description summarization(Set embedding_token_limit in madRAG)
...
def write_json(json_obj, file_name):
    ...
    """
    from madrag.file_atomic import atomic_write
...
async def semantic_cache_lookup(
    ...
    for hit in results:
        ...
        from madrag.base import QueryResult
...
async def aexport_data(
    ...
    if file_format == "csv":
        ...
        with open(output_path, "w", encoding="utf-8") as mdfile:
            mdfile.write("# madRAG Data Export\n\n")
